...
const Sidebar = () => {
  ...
  // Show online users first, then offline users. Do not mutate original arrays.
  ...
  return (
    <aside className="h-full flex-shrink-0 w-full md:w-56 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
